...
def _env_factory(env_name: str, *, split: str, adapter_n16: bool):
    ...
    from cap.saved_scripts.robocasa.policy_eval.gr00t._workers.robocasa365 import (
        _make_env_n16,
    )
...
def main() -> int:
    ...
    from cap.policy.grootpool.backend import GrootpoolBackend
    from cap.policy import InferencePolicyConfig, inference_policy
