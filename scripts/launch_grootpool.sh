...
GROOT_BENCHMARK_ROOT="${GROOT_BENCHMARK_ROOT:-/mnt/amlfs-02/shared/wenli_vla_ft/Isaac-GR00T-benchmark}"
GROOTPOOL_MODEL_PATH="${GROOTPOOL_MODEL_PATH:-/mnt/amlfs-02/shared/wenli_vla_ft/PretrainedModels/gr00t_n1-5/multitask_learning/checkpoint-120000}"
...
HF_HOME="${HF_HOME:-/mnt/amlfs-02/shared/wenli_vla_ft/.cache/huggingface}"
...
if [[ "$MODE" == "real" ]]; then
    ...
    VENV_DIR="${VENV_DIR:-/mnt/amlfs-02/shared/wenli_vla_ft/python_envs/forge}"
