...
- `scripts/launch_robocasa_tmux.sh` — SAM3/AnyGrasp default to localhost and support environment overrides.
- `cap/saved_scripts/archive/robocasa/policy_eval/gr00t/_common/{robocasa365,pandaomron}.py`
  — `gpu-host` fqdn check + `/usr0/<user>` and `/home/<user>/...` checkpoint paths.
