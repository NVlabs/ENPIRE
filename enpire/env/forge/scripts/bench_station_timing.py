...
from enpire.env.forge.robot.station_profiles import active_station_cameras, resolve_station_key

try:
    from enpire.env.forge.robot.yam.yam_real_env import create_camera as _create_station_camera
...
try:
    from enpire.env.forge.robot.camera_factory import create_camera as _create_named_camera
except Exception:
