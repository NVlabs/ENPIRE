...
Usage::
    ...
    from enpire.env.forge.cap.agent.agent_pipeline import AgentPipeline
...
if TYPE_CHECKING:
    from enpire.env.forge.cap.agent.agent_context import AgentContext
    from enpire.env.forge.cap.agent.agent_step import AgentStep
...
class AgentPipeline:
    ...
    def from_config(
        ...
        *,
        ...
        if reflect_llm is not None:
            from enpire.env.forge.cap.agent.reflection import build_reflection_strategy
        ...
        if (
            ...
            from enpire.env.forge.cap.agent.assembly_generator_step import AssemblyGeneratorStep
            from enpire.env.forge.cap.agent.skill_author_step import SkillAuthorStep
    ...
    def run(self, ctx: AgentContext) -> AgentContext:
        ...
        from enpire.env.forge.cap.agent.agent_dashboard import AgentDashboard, dashboard_enabled
    ...
    def _publish_startup_service_health(self, ctx: AgentContext, dash: Any) -> None:
        ...
        try:
            from enpire.env.forge.cap.agent.service_health import (
    ...
    def _run_loop(
        ...
        while not ctx.should_stop and ctx.iteration < self.max_iterations:
            ...
            if ctx.session is not None:
                from enpire.env.forge.cap.agent.tool_log import update_tool_logs
