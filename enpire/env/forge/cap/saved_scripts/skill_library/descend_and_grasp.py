...
def descend_and_grasp_v1(
    ...
    Returns: (grasped, {"grip_val": float, "descend_status": str, "obj_rose": float})
    """
    import numpy as np
    ...
    if likely_contact or descend_result.status != "Success":
        ...
        return False, {"grip_val": 0.0, "descend_status": descend_result.status,
                       "obj_rose": 0.0, "reason": "descend_failed"}

    # Record obj z before grasp for rise check
