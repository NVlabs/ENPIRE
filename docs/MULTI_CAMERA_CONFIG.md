...
_THANOS_CAMERAS = StationCameras((
    ...
    CameraConfig("left",  "realsense", device_id="335122271354"),
    CameraConfig("right", "realsense", device_id="335122271556"),
))
```
...
|---------|------------|-------------|--------------|
| 1 | `231323072070` | `412623070040` | `231323070290` |
| 2 | `323743070310` | `323743070503` | `323743070499` |
| 3 | `323743070401` | `323743070508` | `323743070502` |
| 4 | `323743070505` | `323743070436` | `323743070381` |
| 5 | `323743071280` | `323743071173` | `323743070726` |
| 6 | `307623070316` | `309123070518` | `309123070367` |
...
| Variable | Scope | Example |
|----------|-------|---------|
| `CAP_{NAME}_REALSENSE_SERIAL` | per-camera | `CAP_LEFT_REALSENSE_SERIAL=335122271354` |
| `CAP_REALSENSE_SERIAL` | global | `CAP_REALSENSE_SERIAL=335122271354` |
| `CAP_{NAME}_ZED_SERIAL` | per-camera | `CAP_TOP_ZED_SERIAL=38531109` |
