...
```bash
cd /home/lecar/yiyang/lecar-tbd   # or wherever the repo lives
...
python -m pip install -e /home/yiyang/Workspace/lecar-tbd/third_party/curobo --no-build-isolation
...
```bash
ssh -L 8611:127.0.0.1:8611 lecar@192.168.0.104
```
