...
footswitch:
  type: serial
  button_map: [2, 0, 1]  # measured on 505431655124881C
  serial_port: /dev/serial/by-id/usb-Waveshare_Electronics_RP2040-Zero_505431655124881C-if00
```
...
footswitch:
  type: serial
  serial_port: /dev/serial/by-id/usb-Waveshare_Electronics_RP2040-Zero_5054316520FE531C-if00
  button_map: [0, 2, 1]  # measured on 5054316520FE531C
