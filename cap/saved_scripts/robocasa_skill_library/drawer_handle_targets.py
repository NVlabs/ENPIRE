...
from cap.saved_scripts.robocasa_skill_library.drawer_control_state import (
    drawer_progress,
    get_control_target,
    handle_progress_gap,
)
...
@skill
def drawer_handle_targets_v1(oracle, set_markers=True):
    ...
    progress_by_control = {
        control_name: drawer_progress(oracle, control_name)
