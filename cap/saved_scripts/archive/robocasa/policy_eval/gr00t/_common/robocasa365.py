...
_is_lecar_s1 = "lecar-s1" in _socket.getfqdn().lower()

N16_GROOT_ROOT = Path(os.environ.get(
    "GROOT_ROOT",
    "/usr0/tonghez/Isaac-GR00T" if _is_lecar_s1 else "/home/lecar/Project/Isaac-GR00T",
))
N16_MODEL_PATH = Path(os.environ.get(
    "GROOT_MODEL_PATH",
    "/usr0/tonghez/PretrainedModels/GR00T-N1.6-3B" if _is_lecar_s1
    else "/home/lecar/Project/PretrainedModels/GR00T-N1.6-3B",
))
...
N15_GROOT_ROOT = Path(os.environ.get(
    ...
    "/usr0/tonghez/Isaac-GR00T-benchmark" if _is_lecar_s1 else "",
))
N15_MODEL_PATH = Path(os.environ.get(
    "GROOT_N15_MODEL_PATH",
    "/usr0/tonghez/PretrainedModels/gr00t_n1-5/multitask_learning/checkpoint-120000"
    if _is_lecar_s1 else "",
))
...
ROBOCASA365_ROOT = Path(os.environ.get(
    "ROBOCASA365_ROOT",
    "/usr0/tonghez/robocasa365" if _is_lecar_s1 else "",
))
