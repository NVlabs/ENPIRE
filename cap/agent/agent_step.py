...
if TYPE_CHECKING:
    ...
    from cap.agent.reflection import ReflectionStrategy
...
def _dash_print(msg: str) -> None:
    ...
    try:
        from cap.agent.agent_dashboard import is_active
...
class CodeGeneratorStep(AgentStep):
    ...
    def run(self, ctx: AgentContext) -> AgentContext:
        ...
        if ctx.session is not None:
            ...
            if sl is not None:
                try:
                    from cap.agent.reflection import SkillPromoter
...
class ExecutorStep(AgentStep):
    ...
    def run(self, ctx: AgentContext) -> AgentContext:
        ...
        from cap.agent.executor import Executor
        ...
        def _on_tool_end(
            ...
            from cap.agent.agent_context import ToolCallRecord
            import time as _time
...
class SubprocessExecutorStep(AgentStep):
    ...
    def run(self, ctx: AgentContext) -> AgentContext:
        ...
        from cap.agent.agent_context import AgentEvaluation
        ...
        if exec_mode == "tmux":
            ...
            from cap.agent.agent_dashboard import current as _dash_current
        ...
        try:
            from cap.reward import build_reward_evaluator
...
class SelfReflectionStep(AgentStep):
    ...
    def __init__(self, strategy: ReflectionStrategy | LLMBackend) -> None:
        from cap.agent.reflection import (
