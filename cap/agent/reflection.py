...
Usage::
    ...
    from cap.agent.reflection import TextReflectionStrategy, VisionReflectionStrategy
    from cap.agent.agent_step import SelfReflectionStep
...
def _compute_visual_diff(
    ...
    import numpy as np
    from cap.agent.tools._artifact_log import log_image
    ...
    def promote(self, ctx: AgentContext, iteration_skill_logs: list[dict]) -> int:
        ...
        for node in ast.walk(tree):
            ...
            if name in existing_names:
                ...
                continue
            from cap.agent.skill_registry import _parse_name
