...
if TYPE_CHECKING:
    from cap.agent.agent_context import AgentEvaluation, ExecutionMemory
    from cap.agent.executor import ExecutionResult
...
class AgentRunSession:
    ...
    def close(
        ...
        from cap.agent.profiler import close_file_logging
