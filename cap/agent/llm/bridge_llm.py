...
Usage::
    ...
    from cap.bridge.providers import ClaudeCodeBackend
    from cap.agent.llm.bridge_llm import BridgeLLMBackend
    from cap.bridge.providers.base import AgentBridgeConfig, ProviderContext
...
from cap.bridge.providers.base import AgentBackend, AgentBridgeConfig, ChatSession, ProviderContext
from cap.chat.parsing import extract_code_blocks
