...
from cap.agent.llm.base import LLMBackend  # noqa: F401
from cap.agent.llm.cloud import CloudLLM  # noqa: F401
from cap.agent.llm.gemini import GeminiLLM  # noqa: F401
from cap.agent.llm.nvidia import NvidiaLLM  # noqa: F401
from cap.agent.llm.bridge_llm import BridgeLLMBackend  # noqa: F401
...
def make_llm(
    ...
    *,
    ...
    if backend.startswith("bridge:"):
        ...
        from cap.bridge.providers import AgentBridgeConfig, ProviderContext
