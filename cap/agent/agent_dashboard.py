...
class AgentDashboard:
    ...
    def _render_models(self):
        ...
        n_keys = 0
        try:
            from cap.agent.tools.vlm.backends.nvidia import list_nvidia_keys
    ...
    def _ensure_known_nvidia_keys_locked(self) -> None:
        try:
            from cap.agent.providers.nvidia import list_nvidia_keys, nvidia_key_label
    ...
    def _merge_nvidia_scheduler_stats_locked(self) -> None:
        try:
            from cap.agent.providers.nvidia import read_nvidia_scheduler_stats
