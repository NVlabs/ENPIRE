...
def make_namespace(
    ...
    *,
    ...
    def select_best_grasp(
        ...
        """
        if augment_yaw_flip:
            from cap.env.base.skill_library import GraspCandidate
        ...
        from cap.agent.tools.base import FreespaceBatchCandidate
    ...
    def segment_object(
        ...
        """
        from cap.env.base.skill_library import segment_object_sam3
    ...
    def detect_objects_oneshot(
        ...
        for q in queries:
            ...
            from cap.agent.tools._artifact_log import log_detection, log_mask
    ...
    def sample_grasp_pose_anygrasp(
        ...
        """
        from cap.env.base.skill_library import sample_grasp_anygrasp
        ...
        from cap.agent.tools._artifact_log import log_grasp, log_mask
