...
PI05_POLICY_LAUNCH_SCRIPT = os.environ.get(
    ...
    "/home/lecar/Project/openpi-main/src/openpi/serving/yam/launch_yam_policy_server_functional_grasp.sh",
)
...
LEARN_SKILL_DATA_PATH = "/media/lecar/Extreme SSD/data/learn_skill"
...
RL_DATA_PATH = "/media/lecar/Extreme SSD/data/learn_skill_rl"
...
# VLM servers on lecar-s1.ri.cmu.edu — accessed directly via LAN IP.
SMOL_VLM_URL = os.environ.get("SMOL_VLM_URL", "http://172.26.34.251:8401/v1")
...
HIL_LOG_DIR = Path(os.environ.get("HIL_LOG_DIR", "/home/lecar/logs"))
