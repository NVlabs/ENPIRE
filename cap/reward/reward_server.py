...
from cap.reward.insert_usb.reward import insert_usb_reward
...
def _get_vlm_modes() -> dict[str, Callable]:
    ...
    from cap.reward.gemini_reward import vlm_reward
    from cap.reward.smolvlm_reward import smolvlm_reward
